...
namespace SmartVEye
{
    ...
    /// 1个相机固定排版 忽略DPI
    /// </summary>
    public partial class VisCtrlV1 : VisCtrlBase, IVisCtrl
    {
        #region 参数清单
    ...
    "use_polarity", "auto", "auto", new HTuple(), new HTuple(), out hv_ImgModelHandle);
        ...
        private void VisCtrlV1_Resize(object sender, EventArgs e)
        {
            btn_WidthPlus.Width = panel1.Width / 16;
        ...
        public void DisplayOperateBtn(bool type)
        {
            if (type == true)
            {
                ...
                btn_WidthPlus.Location = new Point(63, 465);  //宽+
                btn_WidthSub.Location = new Point(1560, 465);  //宽-
                btn_HighPlus.Location = new Point(780, 70);    //高+
                btn_HighSub.Location = new Point(780, 870);    //高-
