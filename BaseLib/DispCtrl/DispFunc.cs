...
namespace SmartLib
{
    internal class DispFunc
    {
        internal static void disp_message(HTuple hv_WindowHandle, HTuple hv_String, HTuple hv_CoordSystem,
        ...
        internal static void set_display_font(HTuple hv_WindowHandle, HTuple hv_Size, HTuple hv_Font,
