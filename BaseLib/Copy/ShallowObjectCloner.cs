...
namespace SmartLib
{
    ...
    public abstract class ShallowObjectCloner
    {
        ...
        private static ShallowObjectCloner GenerateUnsafeCloner()
        {
            ...
            var builder = mb.DefineType("ShallowSafeObjectClonerImpl", TypeAttributes.Public,
                typeof(ShallowObjectCloner));
            var ctorBuilder = builder.DefineConstructor(MethodAttributes.Public,
                CallingConventions.HasThis | CallingConventions.HasThis, Type.EmptyTypes);
        ...
        private class ShallowSafeObjectCloner : ShallowObjectCloner
        {
            ...
            static ShallowSafeObjectCloner()
            {
                ...
                _cloneFunc = Expression.Lambda<Func<object, object>>(mce, p)
                    .Compile();
            }
